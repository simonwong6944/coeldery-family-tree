/**
 * MyRecommend — 我的推薦 placeholder 頁
 * 路由：#/my-recommend  規格：細步 3e
 */
...
export default function MyRecommend() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100svh', backgroundColor: 'var(--color-bg)' }}>
      <TopBar titleKey="placeholder.my_recommend_title" onBack={() => { window.location.hash = '#/' }} />
      <main
        style={{
          flex: 1,
          display: 'flex',
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: '18px', color: 'var(--color-text-secondary)', lineHeight: 1.6 }}>
          {t('placeholder.my_recommend_msg')}
        </p>
      </main>
